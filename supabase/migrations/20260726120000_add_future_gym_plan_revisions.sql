-- Preserve the agent-written Gym plan while allowing the owner to deliberately
-- revise a future accepted session. The revision is not a new agent proposal.
alter table public.plans
  add column user_revision_data jsonb,
  add column user_revision_updated_at timestamptz;
